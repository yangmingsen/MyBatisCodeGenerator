...
public class MyCommentGeneratorForFps implements CommentGenerator {
    public static void main(String[] args) {
        ...
        File configFile = new File("generatorFpsConfig.xml");
    ...
    public MyCommentGeneratorForFps() {
        super();
    ...
    public void addModelClassComment(TopLevelClass topLevelClass,
        ...
        topLevelClass.addJavaDocLine(" *"); //$NON-NLS-1$
        topLevelClass.addJavaDocLine(" * create by yangmingsen");
        topLevelClass.addJavaDocLine(" * " + introspectedTable.getFullyQualifiedTable().toString());
        topLevelClass.addJavaDocLine(" */"); //$NON-NLS-1$
//        topLevelClass.addJavaDocLine("@Data"); //$NON-NLS-1$ 不需要@Data
    }
